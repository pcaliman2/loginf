...
class _OWAFAQPageParallaxV3State extends State<OWAFAQPageParallaxV3>
  ...
  final ScrollController _controller = SmoothWheelScrollController();
  ...
  double _footerRevealProgress(double footerHeight) {
    ...
    final remainingScroll = maxScroll - _controller.offset;
                ...
                child: SlideTransition(
                  ...
                  child:
                      isDesktopFromContext(context)
                          ? OWANavbarDesktop(onLogoTap: _goToLandingPage)
                          : OWANavbarDesktop(onLogoTap: _goToLandingPage),
                ),
              ),
            );
